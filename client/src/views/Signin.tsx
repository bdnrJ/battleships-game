...
const Signin = () => {
	...
	return (
		<div className='signin'>
			<form onSubmit={handleSubmit(onLogin)} className='g__form --black'>
				...
				<input type='submit' value={"Sign in"} className='g__button --200w' />
				<div className='g__form--error'>{loginError !== "" ? loginError : ""}</div>
